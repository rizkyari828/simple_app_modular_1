...
class LoginPage extends View {
  ...
  _LoginPageState createState() =>
      new _LoginPageState(AppComponent.getInjector().get<LoginController>());
}
              ...
              children: <Widget>[
                ...
                Container(
                  child: CommonTextInput(
                    isDense: true,
                    isError: controller.errorMessage.employeecode.isNotEmpty,
                    errorText: controller.errorMessage.employeecode,
                    controller: controller.employeeNumberInput,
                    placeholder:
                        S.of(context)?.input_placeholder_employee ?? "",
                    prefixIcon: Icon(
                ...
                Container(
                  child: CommonTextInput(
                    ...
                    placeholder:
                        S.of(context)?.input_placeholder_password ?? "",
                    prefixIcon: Icon(
                      Icons.vpn_key,
                      size: 30,
                    ),
